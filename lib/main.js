...
/**
 * @memberof PodUtilities
 * @description return yyyy-mm-dd hh:mm in UTC
 * @param {Date} d
 * @returns string
 */
function dateToStringToMinUtc (d) {
...
/**
 * @memberof PodUtilities
 * @description return yyyy-mm-dd hh:mm:ss
 * @param {Date} d
 * @returns string
 */
...
/**
 * @memberof PodUtilities
 * @description return yyyy-mm-dd hh:mm:ss in UTC
 * @param {Date} d
 * @returns string
 */
function dateToStringUtc (d) {
  return d.getUTCFullYear() + '-' +
    ('00' + (d.getUTCMonth() + 1)).slice(-2) + '-' +
    ('00' + d.getUTCDate()).slice(-2) + ' ' +
    ('00' + d.getUTCHours()).slice(-2) + ':' +
...
/**
 * @description Converts a shamsi string to a miladi string
 * @param {string} shamsiString
 * @returns string
 */
function shamsiStringToMiladiStringToMin (shamsiString) {
  return moment(shamsiString, 'jYYYY/jM/jD HH:mm').format('YYYY-M-D HH:mm');
}
...
module.exports.dateToStringToMin = dateToStringToMin;
module.exports.dateToStringToMinUtc = dateToStringToMinUtc;
module.exports.dateToString = dateToString;
module.exports.dateToStringUtc = dateToStringUtc;
module.exports.moment = moment;
module.exports.shamsiStringToMiladiStringToMin = shamsiStringToMiladiStringToMin;
